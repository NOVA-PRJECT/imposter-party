...
export default function HomeScreen({ gameState }: HomeScreenProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-between min-h-[100dvh] px-4 py-6 sm:py-10 max-w-md sm:max-w-lg w-full mx-auto relative">
      {/* Top Title Header */}
      ...
      {/* Main Form Container */}
      <div className="w-full bg-surface border border-border rounded-card p-5 sm:p-8 shadow-2xl space-y-4">
        {/* Tab Switcher */}
        <div className="grid grid-cols-2 gap-2 p-1 bg-surface2 rounded-card">
          <button
            type="button"
            onClick={() => setTab('create')}
            className={`py-3 text-sm sm:text-base font-bold rounded-card transition-colors ${
              tab === 'create'
          ...
          <form onSubmit={handleCreate} className="space-y-5">
            <div>
              ...
              <input
                ...
                maxLength={16}
                required
                className="w-full px-4 py-3 sm:py-3.5 bg-surface2 border border-border rounded-card text-primary placeholder-muted focus:outline-none focus:border-accent text-base"
              />
            </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <span className="text-sm text-accent font-mono font-bold">{maxPlayers} players</span>
              </div>
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="w-10 h-10 rounded-card bg-surface2 text-primary font-bold border border-border disabled:opacity-30 flex items-center justify-center text-lg active:scale-95 transition-transform"
                >
                  -
                </button>
                <input
                  ...
                  className="w-full accent-accent bg-surface2 cursor-pointer h-2 rounded-lg"
                />
                <button
                  type="button"
          ...
          <form onSubmit={handleJoin} className="space-y-5">
            <div>
              ...
              <input
                ...
                maxLength={6}
                required
                className="w-full px-4 py-3 sm:py-3.5 bg-surface2 border border-border rounded-card text-primary placeholder-muted focus:outline-none focus:border-accent font-mono text-center tracking-widest text-lg sm:text-xl uppercase"
              />
            </div>
            <div>
              <label className="block text-xs font-mono uppercase text-muted mb-1">
      ...
      <div className="w-full mt-6 grid grid-cols-2 gap-3">
        <button
          ...
          className="p-3 sm:p-3.5 rounded-card bg-surface border border-border hover:border-accent/60 text-xs sm:text-sm font-bold text-muted hover:text-primary flex items-center justify-center gap-2 transition-all shadow"
        >
      ...
      {activeModal === 'about_game' && (
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8 max-w-lg w-[92vw] max-h-[85vh] overflow-y-auto space-y-4 shadow-2xl relative animate-fadeIn">
            <button
            ...
            <div className="text-center border-b border-border pb-3">
              ...
              <h2 className="text-2xl font-extrabold text-primary">About The Game</h2>
            ...
            <div className="space-y-3 text-xs sm:text-sm text-zinc-300 leading-relaxed">
              <div className="p-3.5 rounded-card bg-surface2 border border-border">
              ...
              <div className="p-3.5 rounded-card bg-surface2 border border-border">
                ...
                <ol className="list-decimal list-inside space-y-1 text-zinc-300">
                  ...
                  <li>Discuss out loud! Ask clever questions without giving away the word.</li>
              ...
              <div className="p-3.5 rounded-card bg-surface2 border border-border space-y-1">
                <strong className="text-accent block text-sm">✨ Key Features</strong>
                <ul className="list-disc list-inside space-y-1 text-zinc-400">
                  <li>10 Curated Word Categories (Food, Landmarks, Vehicles, Hobbies...)</li>
                  <li>Multi-Category Ticking with Anti-Adjacency</li>
                  <li>Among Us Tablet Voting Screen with "I VOTED" badges</li>
                  <li>Web Audio Retro Sound Effects & Floating Mute Toggle</li>
                  <li>Custom Words Management (Add, Edit, Delete)</li>
                </ul>
              </div>
            </div>
      ...
      {activeModal === 'about_creator' && (
        <div className="fixed inset-0 z-50 bg-black/85 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-surface border border-border rounded-2xl p-6 sm:p-8 max-w-lg w-[92vw] space-y-4 shadow-2xl relative animate-fadeIn">
            <button
              onClick={() => setActiveModal(null)}
              className="absolute top-4 right-4 text-zinc-400 hover:text-white font-bold text-xl p-1"
            >
            ...
            <div className="text-center border-b border-border pb-3">
              <span className="text-3xl">🚀</span>
              <h2 className="text-2xl font-extrabold text-primary">About Creator</h2>
            ...
            <div className="space-y-3.5 text-xs sm:text-sm text-zinc-300 leading-relaxed">
              ...
              <div className="p-3.5 rounded-card bg-surface2 border border-border space-y-2">
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 w-full py-3.5 px-4 rounded-card bg-zinc-800 hover:bg-zinc-700 border border-zinc-600 text-white font-bold text-sm transition-colors shadow"
              >
